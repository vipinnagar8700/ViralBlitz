    ...
    >
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerText}> Finished signing up</Text>
          <Text></Text>
        </View>
        <View></View>
        ...
        <View style={styles.inputBox}>
         ...
         <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:20}}>
          <Text style={styles.notADoctorTexta}>
          Subscribe to marketing emails
          </Text>
          <Checkbox isChecked={subscribeToEmails} onChange={setSubscribeToEmails} />
         </View>
        </View>
